...
// pointLight.position.y = 3;
// pointLight.position.z = 4;
pointLight2.position.set(-1.39, 2.12, -0.99);
pointLight2.intensity = 4.68;
...
pointLight3.position.set(1, -3, -0.7);
...
light2.add(pointLight3.position, "z").min(-6).max(3).step(0.01);
